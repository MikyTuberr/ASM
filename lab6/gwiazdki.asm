...
obsluga_zegara PROC
	...
	; zawartoœæ rejestru ES przez 16
	 ...
	 mov cx, cs:sekundnik ;licznik do 18 ~ 1 sek
	 add cx, 1
	 cmp cx, 1
	 jb wysw_dalej_2
	...
	; i kodu koloru: zolty na niebieskim tle (do nastêpnego bajtu)
	 mov byte PTR es:[bx], '*' ; kod ASCII
	 mov byte PTR es:[bx+1], 00011110b; 14
...
wysw_dalej:
	 mov cs:licznik,bx 	;zapisanie adresu bie¿¹cego do zmiennej 'licznik'
...
wysw_dalej_2:
	...
	licznik dw 0 ; wyœwietlanie pocz¹wszy od 0. wiersza 
	linia dw 0
	sekundnik dw 0
	wektor8 dd ?
obsluga_zegara ENDP
